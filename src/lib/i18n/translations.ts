...
const translations = {
  en: {
    ...
    metrics: {
      title: 'Transcode metrics',
      empty: 'No transcode runs yet. Upload a video to record a run.',
      loading: 'Loading runs…',
      error: 'Could not load metrics.',
      machine: 'Machine',
      codec: 'Codec',
      runs: 'Runs',
      avgElapsed: 'Avg time (s)',
      avgCpu: 'Avg CPU %',
      maxCpu: 'Max CPU %',
    ...
    distribution: {
      ...
      error: 'Could not load distribution data.',
      projections: 'Cloud projections',
      col: {
        tier: 'Tier',
        viewers: 'Viewers',
        machine: 'Machine',
        engine: 'Engine',
        startup: 'Startup p50 (ms)',
        startupP95: 'Startup p95 (ms)',
        startupP99: 'Startup p99 (ms)',
        rebuffer: 'Rebuffer %',
        bitrate: 'Bitrate (kbps)',
        protocol: 'Protocol',
        abrSwitches: 'ABR switches',
        stalls: 'Stalls',
        samples: 'Samples',
        target: 'Target viewers',
        egress: 'Egress (GB/h)',
        rps: 'Agg RPS',
        connections: 'Connections',
        cost: '$/month',
        saturation: 'Saturation tier',
      },
    },
    roles: {
      admin: 'ADMIN',
  ...
  es: {
    ...
    metrics: {
      title: 'Métricas de transcodificación',
      empty: 'Aún no hay ejecuciones de transcodificación. Sube un video para registrar una.',
      loading: 'Cargando ejecuciones…',
      error: 'No se pudieron cargar las métricas.',
      machine: 'Máquina',
      codec: 'Codec',
      runs: 'Ejecuciones',
      avgElapsed: 'Tiempo medio (s)',
      avgCpu: 'CPU media %',
      maxCpu: 'CPU máx %',
    ...
    distribution: {
      ...
      error: 'No se pudieron cargar los datos de distribución.',
      projections: 'Proyecciones en la nube',
      col: {
        tier: 'Nivel',
        viewers: 'Espectadores',
        machine: 'Máquina',
        engine: 'Motor',
        startup: 'Inicio p50 (ms)',
        startupP95: 'Inicio p95 (ms)',
        startupP99: 'Inicio p99 (ms)',
        rebuffer: 'Rebúfer %',
        bitrate: 'Bitrate (kbps)',
        protocol: 'Protocolo',
        abrSwitches: 'Cambios ABR',
        stalls: 'Stalls',
        samples: 'Muestras',
        target: 'Espectadores objetivo',
        egress: 'Salida (GB/h)',
        rps: 'RPS agg.',
        connections: 'Conexiones',
        cost: '$/mes',
        saturation: 'Nivel saturación',
      },
    },
    roles: {
      admin: 'ADMIN',
  ...
  pt: {
    ...
    metrics: {
      title: 'Métricas de transcode',
      empty: 'Nenhuma execução de transcode ainda. Envie um vídeo para registrar uma execução.',
      loading: 'Carregando execuções…',
      error: 'Não foi possível carregar as métricas.',
      machine: 'Máquina',
      codec: 'Codec',
      runs: 'Execuções',
      avgElapsed: 'Tempo médio (s)',
      avgCpu: 'CPU média %',
      maxCpu: 'CPU máx %',
    ...
    distribution: {
      ...
      empty: 'Nenhuma execução de distribuição ainda. Execute um teste de carga para ver os resultados.',
      error: 'Não foi possível carregar os dados de distribuição.',
      projections: 'Projeções na nuvem',
      col: {
        tier: 'Nível',
        viewers: 'Espectadores',
        machine: 'Máquina',
        engine: 'Engine',
        startup: 'Início p50 (ms)',
        startupP95: 'Início p95 (ms)',
        startupP99: 'Início p99 (ms)',
        rebuffer: 'Rebuffer %',
        bitrate: 'Bitrate (kbps)',
        protocol: 'Protocolo',
        abrSwitches: 'Trocas ABR',
        stalls: 'Travadas',
        samples: 'Amostras',
        target: 'Espectadores alvo',
        egress: 'Egress (GB/h)',
        rps: 'RPS agg.',
        connections: 'Conexões',
        cost: '$/mês',
        saturation: 'Nível saturação',
      },
    },
    roles: {
      admin: 'ADMIN',
